...
chasing_rabbits.articles.create(
    ...
    body: <<-BODY.strip_heredoc
        ...
        amet egestas erat. In egestas molestie mauris ac volutpat. Mauris mollis,
        arcu eu condimentum cursus, tellus augue mattis augue, vitae accumsan quam
        ante sed felis. Praesent congue elementum neque a auctor. Quisque velit
        lorem, porta sit amet sapien sit amet, fringilla finibus dolor. Interdum et
        malesuada fames ac ante ipsum primis in faucibus. Donec non ligula ac metus
        sollicitudin laoreet sed eu tortor. Quisque quis consectetur urna. Aliquam
        posuere, ipsum ac pellentesque egestas, odio leo commodo purus, id
        tristique tellus odio sit amet nunc. Aliquam ultricies orci nec dolor
        commodo consequat. Integer eu tortor sed elit imperdiet mollis porta porta
        libero. Morbi et pharetra libero. Donec egestas ipsum vel nunc luctus, ut
        vulputate mauris fringilla. Cras et sodales elit. Fusce turpis sapien,
        congue a augue vel, vehicula varius tellus. Fusce vitae odio ut sapien
        blandit elementum ut vitae neque.
